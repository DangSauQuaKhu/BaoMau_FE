    ...
    <div className='pt-5 pb-16 mt-10 grid grid-cols-5 rounded-xl border border-black shadow-[0_2px_1px_-1px_black]'>
      ...
      <div className='col-start-2 ml-4 col-span-3 flex-col'>
        ...
        <div className='flex text-[20px] mt-4'>
          <div className='line-clamp-1 w-[11vw]'>Tuổi : {postPayment.age}</div>
          <div className='line-clamp-1 w-[19vw]'>Kinh nghiệm : {postPayment.experience} năm</div>
          <div className='line-clamp-1'>Lương : {displayNum(postPayment.salary)}</div>
        </div>
        <div className='text-[20px] mt-4'>Ngày bắt đầu : {convertDate(postPayment.dateStart)}</div>
