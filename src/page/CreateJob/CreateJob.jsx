...
export default function CreateJob() {
  ...
  const onSubmit = handleSubmit((data) => {
    ...
    newPost.mutate(body, {
      onSuccess: (data) => {
        //console.log(data)
        toast('Đã thêm bài viết mới !') // 。(15)data.data?.message
        ...
        <form className='text-4xl leading-relaxed' onSubmit={onSubmit}>
          ...
          <div className='p-20'>
            <div className='flex flex-row items-center'>
              <div className='w-60 mr-20'>Tiêu đề :</div>
              <input
                required
                type='text'
                name='title'
            ...
            <div className='flex flex-row items-center mt-20'>
              <div className='mr-56'>Đối tượng :</div>
            ...
            <div className='border-2 border-black p-16 rounded-[20px] mt-16 shadow-[0px_4px_4px_rgba(0,0,0,0.25)]'>
              <div className='flex flex-row items-center justify-between'>
                <div className='flex flex-row items-center'>
                  <div className='mr-10'>Địa chỉ :</div>
                  <input
                    required
                    type='text'
                    name='address'
                ...
                <div className='flex flex-row items-center mr-20'>
                  <div className='mr-10'>Ngày bắt đầu :</div>
                  <input
                    type='date'
                    required
                    name='dateStart'
              ...
              <div className='mt-12'>Thông tin công việc:</div>
            ...
            <div className='border-2 border-black p-16 rounded-[20px] mt-16 shadow-[0px_4px_4px_rgba(0,0,0,0.25)]'>
              <div className='text-5xl font-semibold'>Yêu cầu</div>
              <div className='flex flex-row items-center mt-10'>
                <div className='mr-10'>Tuổi :</div>
                <input
                  type='text'
                  required
                  name='age'
                ...
                />
                <div className='ml-4'>(trở lên)</div>
              </div>
              <div className='flex flex-row items-center mt-10'>
                <div className='mr-10'>Kinh nghiệm :</div>
                <input
                  required
                  type='text'
                  name='experience'
              ...
              <div className='flex flex-row items-center mt-10'>
                <div className='mr-10'>Ngôn ngữ :</div>
                <input
                  type='text'
                  name='language'
                  {...register('language')}
