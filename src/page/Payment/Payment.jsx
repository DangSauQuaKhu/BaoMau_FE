      ...
      {payment && (
        <div>
          <div className=' bg-[#DCEAFF] flex justify-center items-center flex-col'>
            <div className='w-4/5 bg-[#FFF] text-center mt-36 rounded-3xl p-8 text-6xl font-bold'>Chi tiết hợp đồng</div>
            <div className='flex w-[95vw] h-[150vh] m-auto gap-16 mt-12'>
                ...
                <div className='flex-1 m-5 p-12 bg-[#FFF] rounded-[20px] border-[1px] border-black'>
                  ...
                  <div className='mt-16 mx-6'>
                    <div className='flex flex-row p-2 border-y-[1px] border-black gap-20 text-center'>
                      <div className='ml-12 w-48'>số ca làm việc</div>
                      <div className='w-64'>Tiền/ca</div>
                      <div className='ml-auto mr-20 w-52'>Tổng phí</div>
                    </div>
                    <div className='flex flex-row p-2 gap-20 mt-2 text-center items-center'>
                      ...
                      <div className='w-64 flex items-center justify-center'>
                        <div className='w-48 bg-[#D9D9D9] rounded-[10px] p-3'>
                          {displayNum(payment.requestID.postID.salary)} nghìn VND
                        </div>
                      </div>
                      <div className='ml-auto mr-20 w-52 flex items-center justify-center'>
                        <div className='w-48 bg-[#D9D9D9] rounded-[10px] p-3'>{displayNum(payment.totalPrice)*1000/4} nghìn VND </div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className='flex flex-1 flex-col gap-16'>
                <div className='flex-1 m-5 bg-[#FFF] rounded-[20px] border-[1px] border-black p-10'>
                  <div className='text-center text-4xl'>Thông tin khác</div>
                  <div className='flex flex-col gap-2 text-[18px] mt-12'>
                    ...
                    <div className='flex flex-row'>
                      <div>Số ca làm việc mỗi tuần:</div>
                      <div className='ml-auto'>{payment.count} ca</div>
                    </div>
                    <div className='flex flex-row'>
                      <div>Tiền:</div>
                      <div className='ml-auto'>{displayNum(payment.requestID.postID.salary)} nghìn VND</div>
                    </div>
                ...
                <div className='flex-1 m-5 bg-[#FFF] rounded-[20px] border-[1px] border-black p-10'>
                  <div className='text-5xl m-6'>Tổng phí (nghìn VND)</div>
                  <div className='text-7xl m-6 mt-20'>{displayNum(payment.totalPrice)*1000/4} </div>
                  <div className='text-4xl m-6'></div>
                  {payment.status === 1 ? (
