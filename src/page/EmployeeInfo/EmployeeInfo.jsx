          ...
          <div className='text-4xl leading-relaxed'>
              ...
              <div className='flex flex-row items-center'>
                ...
                <div className='ml-20 font-bold text-5xl'>
                  ...
                  <div className='text-3xl/relaxed'>
                    ...
                    <div>
                      Tuổi : {getAges(employee.data.dateOB)}tuổi&emsp;Kinh nghiệm: {employee.data.experience}
                      <br />
                      Giá dịch vụ: {displayNum(employee.data.salary)} (nghìn VND)&emsp;Ngày đăng kí: {''}
            ...
            <div className='mt-12'>
              <div className='flex flex-row items-center'>
                ...
                <div className='ml-12 font-semibold'>Giới thiệu bản thân:</div>
              </div>
            ...
            <div className='mt-12 px-20 leading-[5rem]'>
              ...
              <ul className='list-disc marker:text-[#7101FF]'>
                <div className='columns-xl'>
                  <li>Năm sinh: {convertDate(employee.data.dateOB)}</li>
                  <li>Giới tính: {employee.data.gender}</li>
                  <li>Kinh nghiệm: {employee.data.experience}</li>
                  <li>Ngôn ngữ: Tiếng nhật, tiếng anh</li>
                  <li>Bằng cấp: {employee.data.degree}</li>
                </div>
