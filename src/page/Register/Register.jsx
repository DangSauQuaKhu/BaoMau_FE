...
export default function Register() {
  ...
  const onSubmit = handleSubmit((data) => {
    ...
    registerAccontMutation.mutate(body, {
      onSuccess: (data) => {
        console.log(data)
        toast.success('Đăng kí thành công !') // 。(21)
        navigate('/login')
      },
      onError: (error) => {
        console.log(error)
  ...
  return (
    <div className='font-itim'>
      <div className='flex w-full justify-between items-center pb-16 px-10'>
        ...
        <div className='text-6xl text-[#D324D7] mr-48 mt-28'>Đăng ký</div>
      </div>
      <form className='w-full px-10' onSubmit={onSubmit} noValidate>
        ...
        <div>
          <label className='block mb-2 text-xl text-black'>Chọn đối tượng</label>
